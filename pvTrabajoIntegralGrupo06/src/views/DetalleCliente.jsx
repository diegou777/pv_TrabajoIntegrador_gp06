      ...
      <Paper elevation={4} sx={{ p: 4, borderRadius: 3 }}>
        ...
        <Stack spacing={3}>
          <Paper variant="outlined" sx={{ p: 3, borderRadius: 2 }}>
            ...
            <Typography>
              <strong>Nombre completo:</strong> {name?.firstname}{" "}
              {name?.lastname}
            </Typography>
          ...
          {esSoporte && (
            <Alert severity="info">
              Modo solo lectura: el sector Soporte puede visualizar la ficha,
              pero no tiene permisos para eliminar clientes.
            </Alert>
          )}
